...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const title = initialData ? "Area de edição de produto." : "Área de criação de Produtos.";
  const description = initialData ? "Editar um produto." : "Crie um novo produto.";
  const toastMessage = initialData ? "Produto atualizado com sucesso!" : "Produto criado com sucesso!";
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <FormField control={form.control} name="price" render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="number" disabled={loading} placeholder="Preço do produto" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField control={form.control} name="isArchived" render={({ field }) => (
              <FormItem className="flex flex-row itens-start space-x-3 space-y-0 rounded-md border p-4">
                ...
                <div className="space-y-1 leading-none">
                  ...
                  <FormDescription>
                    Esse produto não aparecerá em nenhum lugar na loja.
                  </FormDescription>
                </div>
              </FormItem>
            )} />
